...
<table style="width: 100%; border-collapse: collapse; table-layout: fixed;">
    ...
    window.onload = () => {
    // চেক করা হচ্ছে সে কি আপনার ইনডেক্স পেজ থেকে এসেছে কি না
    const referrer = document.referrer;
    
    // যদি সে সরাসরি URL টাইপ করে আসে (Referrer খালি থাকে) 
    // অথবা আপনার সাইট ছাড়া অন্য কোথাও থেকে আসে
    if (!referrer.includes("index.html")) {
        window.location.href = "warning.html"; // তাকে মেইন পেজে পাঠিয়ে দাও
        return;
    }

    // যদি সে আপনার ইনডেক্স পেজ থেকে ক্লিক করে আসে, তবেই ডাটা লোড হবে
    initFilters();
    loadGroups(); 
};
